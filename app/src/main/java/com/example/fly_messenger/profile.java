...
public class profile extends AppCompatActivity {
    ...
    String defaultProfilePicUrl = "default";
    boolean isProfilePicSet = false;
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (email != null && password != null && name != null && profile != null && status != null) {
                    ...
                    if (!profile.equals(defaultProfilePicUrl)) {
        ...
        donebut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (setImageUri != null) {
                    ...
                    String finalImageUri = isProfilePicSet ? defaultProfilePicUrl : "";
                    Users users = new Users(auth.getUid(), name, email, password, finalImageUri, status);
                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
